...
const navItems: NavItem[] = [
  ...
  { href: "/portal/gw-overview", label: "GW Overview" },
  ...
  return (
    <div className="min-h-full bg-brand-dark text-brand-cream">
      ...
      <div className="mx-auto flex min-h-full max-w-[1440px] md:min-h-[calc(100vh-8rem)]">
        <aside className="hidden w-72 flex-col border-r border-brand-cream/20 bg-brand-dark px-4 py-6 md:sticky md:top-0 md:flex md:h-screen md:overflow-y-auto">
