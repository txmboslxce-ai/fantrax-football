...
const FEATURE_SELECT = [
  ...
  "season_corner_kicks_per90",
  "last10_corner_kicks_per90",
  "last5_corner_kicks_per90",
  "season_free_kick_shots_per90",
  "last10_free_kick_shots_per90",
  "last5_free_kick_shots_per90",
...
export async function loadPlayerPredictionFeatures(
  ...
  return (data ?? []) as unknown as PlayerPredictionFeatureRow[];
}
