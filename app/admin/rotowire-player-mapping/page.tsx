import RotowirePlayerMappingClient from "./RotowirePlayerMappingClient";
import { isAdminEmail } from "@/lib/admin";
import { createServerSupabaseClient } from "@/lib/supabase-server";

export default async function RotowirePlayerMappingPage() {
  ...
  return <RotowirePlayerMappingClient />;
}
