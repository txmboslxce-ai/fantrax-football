...
export async function getGWOverviewData(startGwParam?: string | string[]): Promise<GWOverviewTabData> {
  ...
  const rawStartGw = Array.isArray(startGwParam) ? startGwParam[0] : startGwParam;
